...
export default function Footer() {
  ...
  return (
    <>
      <footer className="bg-gray-900 text-white" style={{ marginTop: '2.5rem' }}>
        {/* IKTA Brand Top Bar */}
        <div className="h-1 ikta-gradient" />

        <div className="container mx-auto px-4" style={{ paddingTop: '3rem', paddingBottom: '2.5rem' }}>
