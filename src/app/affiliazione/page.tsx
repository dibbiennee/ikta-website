      ...
      <section className="section" style={{ marginTop: '100px' }}>
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h1 className="text-3xl md:text-5xl font-bold mb-4">I Vantaggi dell&apos;Affiliazione</h1>
      ...
      <section className="section-dark section">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="https://wa.me/393384012397"
              target="_blank"
              rel="noopener noreferrer"
              className="btn bg-[#25D366] text-white hover:bg-[#1da851] px-8"
            >
            ...
            <a
              href="mailto:massimo.brizi@tiscali.it?subject=Richiesta%20Affiliazione%20IKTA"
              className="btn text-white hover:bg-white hover:text-gray-900 px-8"
